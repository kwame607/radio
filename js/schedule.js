...
(function () {
  ...
  const WEEKDAY = [
    ...
    { start: 12, end: 14, name: "Angel Breaking News", host: "Angel Newsroom", cat: "News", desc: "Live coverage and analysis of the biggest breaking stories of the day." },
    { start: 14, end: 16, name: "The Platform", host: "Angel FM", cat: "Talk", desc: "In-depth discussion on the issues shaping the nation." },
